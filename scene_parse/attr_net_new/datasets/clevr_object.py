...
class ClevrObjectAttributeDataset(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        dataset = ClevrObjectDataset(self.args.clevr_ann_path, self.args.clevr_img_h5, self.args.attr_names, max_img_id=self.args.split_id)
    ...
    def val_dataloader(self):
        dataset = ClevrObjectDataset(self.args.clevr_ann_path, self.args.clevr_img_h5, self.args.attr_names, min_img_id=self.args.split_id)
        dataloader = DataLoader(
            dataset,
            batch_size=self.args.batch_size,
            num_workers=self.args.num_workers,
