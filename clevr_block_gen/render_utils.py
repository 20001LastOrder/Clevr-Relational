...
def render_scene(args,
  ...
  blender_objects = add_objects(args, scene_struct, camera, objects, properties)
...
def add_objects(args, scene_struct, camera, objects, properties):
  ...
  for i, obj in enumerate(objects):
    ...
    utils.add_object(args.shape_dir,
                     properties['shapes'][obj["shape"]],
                     properties['sizes'][obj["size"]],
                     obj["location"],
                     theta=obj["rotation"])
    ...
    utils.add_material(properties['materials'][obj["material"]], Color=properties['colors'][obj["color"]])
...
def overlap(o1, o2, properties):
    return (abs(o1['location'][0] - o2['location'][0]) < (properties['sizes'][o1['size']] + properties['sizes'][o2['size']]))

  
def above(o1, o2, properties):
  return overlap(o1, o2, properties) and (o1['location'][2] - o2['location'][2]) > 0


def below(o1, o2, properties):
  return overlap(o1, o2, properties) and (o2['location'][2] - o1['location'][2]) > 0
