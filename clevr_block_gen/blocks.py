...
class Block(object):
  ...
  def overlap(o1, o2):
    return (abs(o1.x - o2.x) < (properties['sizes'][o1.size] + properties['sizes'][o2.size]))

  def stable_on(o1, o2):
    return (abs(o1.x - o2.x) < properties['sizes'][o2.size])
...
class State(object):
  ...
  def __init__(self,args):
    objects         = []
    num_objects = random.randrange(args.min_objects, args.max_objects)
